...
class Window:
    def __init__(self, root):
        ...
        self.message = Label(root, text="Enter Target URL: ", font=("bold", 10))
        ...
        self.spam = Button(root, command=self.spam)
        self.spam.grid(row=self.first_row + 1, column=self.first_column + 1)
